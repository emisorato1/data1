"""
Loader para descargar documentos DOCX desde OpenText Content Server.
...
def load_from_opentext(data_id: int, metadata: dict = None) -> Document:
    """
    Descarga un DOCX desde Content Server y lo parsea.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print(f"Descargado: {len(doc.content)} caracteres, {doc.metadata['num_paragraphs']} párrafos")
    else:
