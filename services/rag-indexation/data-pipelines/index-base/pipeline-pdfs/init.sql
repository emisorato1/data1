-- ============================================================================
-- Pipeline PDFs - Inicialización (Compatible con esquema existente)
-- ============================================================================
-- Este script asume que la base de datos ya tiene:
-- - Extensión 'vector' habilitada
-- - Tabla 'documents' con estructura: id, content, embedding, metadata, created_at
-- ============================================================================
...
-- ============================================================================
-- La tabla principal 'documents' ya existe con esta estructura:
--
...
--   );
--
-- Para insertar documentos desde el pipeline, usar:
--   INSERT INTO documents (content, embedding, metadata)
--   VALUES ('...', '[...]'::vector, '{"description": "private", "source": "pdf", ...}');
--
-- La visibilidad se controla via metadata->>'description' = 'public' | 'private'
-- ============================================================================

COMMENT ON
TABLE pipeline_runs IS 'Registro de ejecuciones del pipeline de indexación';

COMMENT ON
TABLE document_pipeline_metadata IS 'Metadata extendida de documentos procesados (medallion: bronze/silver/gold)';