#!/usr/bin/env python3
"""
Test de descarga y chunking (SIN embeddings ni BD).
...
def test_document(data_id: int, extra_metadata: dict = None, save: bool = False):
    ...
    try:
        ...
        print(f"   Páginas: {document.metadata.get('num_pages', 'N/A')}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Test de descarga y chunking (sin embeddings)"
    )
    parser.add_argument(
        "data_ids",
        nargs="*",
